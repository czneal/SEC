...
def join_sec_stocks_tickers(
        shares: Dict[str, List[Share]],
        tickers: Dict[str, List[str]]) -> bool:
    full_join = True
...
if __name__ == '__main__':
    ...
    true_shares: List[Tuple[str, str, str]] = [
        ('0000318306-13-000004', 'us-gaap:CommonStockMember', 'AACP'),
        ...
        ('0001331875-16-000111',
         'fnf:FidelityNationalFinancialGroupCommonStock', 'FNF'),
        ('0001331875-17-000031',
         'fnf:FidelityNationalFinancialGroupCommonStock', 'FNF'),
        ...
        ('0000063754-13-000002', 'us-gaap:CommonStockMember', 'MKC.V'),
        ('0000063754-14-000008', 'us-gaap:NonvotingCommonStockMember', 'MKC'),
        ('0000063754-14-000008', 'us-gaap:CommonStockMember', 'MKC.V'),
        ('0000063754-15-000013', 'us-gaap:NonvotingCommonStockMember', 'MKC'),
        ('0000063754-15-000013', 'us-gaap:CommonStockMember', 'MKC.V'),
        ('0000063754-16-000063', 'us-gaap:NonvotingCommonStockMember', 'MKC'),
        ('0000063754-16-000063', 'us-gaap:CommonStockMember', 'MKC.V'),
        ('0000063754-17-000014', 'us-gaap:NonvotingCommonStockMember', 'MKC'),
        ('0000063754-17-000014', 'us-gaap:CommonStockMember', 'MKC.V'),
        ('0000063754-18-000008', 'us-gaap:NonvotingCommonStockMember', 'MKC'),
        ('0000063754-18-000008', 'us-gaap:CommonStockMember', 'MKC.V'),
        ('0000063754-19-000017', 'us-gaap:NonvotingCommonStockMember', 'MKC'),
        ('0000063754-19-000017', 'us-gaap:CommonStockMember', 'MKC.V'),
        ...
        ('0001558370-18-001400', 'linta:QvcGroupCommonClassMember', 'QRTEA'),
        ...
        ('0000024545-15-000004', 'us-gaap:CommonClassAMember', 'TAP.A'),
        ('0000024545-16-000054', 'us-gaap:CommonClassBMember', 'TAP'),
        ('0000024545-16-000054', 'us-gaap:CommonClassAMember', 'TAP.A'),
        ('0000024545-17-000005', 'us-gaap:CommonClassBMember', 'TAP'),
        ('0000024545-17-000005', 'us-gaap:CommonClassAMember', 'TAP.A'),
        ('0000024545-18-000009', 'us-gaap:CommonClassBMember', 'TAP'),
        ('0000024545-18-000009', 'us-gaap:CommonClassAMember', 'TAP.A'),
        ('0000024545-19-000007', 'us-gaap:CommonClassBMember', 'TAP'),
        ('0000024545-19-000007', 'us-gaap:CommonClassAMember', 'TAP.A'),
    ...
    data.extend(true_shares)
    df = pd.DataFrame(data,  columns=['adsh', 'member', 'ticker'])
    with do.OpenConnection() as con:
        cur = con.cursor(dictionary=True)
        table = do.MySQLTable('sec_shares_ticker', con)
        table.write(df, cur)
        con.commit()
